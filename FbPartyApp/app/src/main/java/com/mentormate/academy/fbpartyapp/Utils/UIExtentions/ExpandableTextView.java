package com.mentormate.academy.fbpartyapp.Utils.UIExtentions;
...
public class ExpandableTextView extends TextView {
    ...
    private CharSequence getTrimmedText(CharSequence text) {
        if (originalText != null && originalText.length() > trimLength) {
            return new SpannableStringBuilder(originalText, 0, trimLength + 1).append(VIEW_MORE);
        } else {
            return originalText + VIEW_LESS;
        }
    }
